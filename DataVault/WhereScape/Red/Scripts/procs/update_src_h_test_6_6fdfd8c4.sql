...
-- Procedure Name   :    update_src_h_test_6_6fdfd8c4
...
-- Generated on     :    Tuesday, July 11, 2023 at 10:44:39
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_test_6_6fdfd8c4].update_src_h_test_6_6fdfd8c4
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_test]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_test_redding.hk_h_test AS hk_h_test
           , stage_test_redding.test_no AS test_no
           , stage_test_redding.test_no_bkcc AS test_no_bkcc
           , stage_test_redding.tenant_id AS tenant_id
           , stage_test_redding.dss_record_source AS dss_record_source
           , stage_test_redding.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_test_redding] stage_test_redding
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[h_test] h_test
        WHERE  stage_test_redding.test_no = h_test.test_no
        AND    stage_test_redding.test_no_bkcc = h_test.test_no_bkcc
        AND    stage_test_redding.tenant_id = h_test.tenant_id
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_test_6_6fdfd8c4 FAILED with error '
