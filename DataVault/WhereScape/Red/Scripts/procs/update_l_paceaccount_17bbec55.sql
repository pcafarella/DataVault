...
-- Procedure Name   :    update_l_paceaccount_17bbec55
...
-- Generated on     :    Thursday, October 06, 2022 at 10:09:57
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_paceaccount_17bbec55].update_l_paceaccount_17bbec55
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_paceaccount_invoice]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT CAST(NULL AS NCHAR(64)) AS hk_l_paceaccount_invoice
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_paceaccount_17bbec55 FAILED with error '
