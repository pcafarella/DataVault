...
-- Procedure Name   :    update_stage_custome_bd31bfd7
-- Template         :    wsl_sqlserver_proc_dv_stage_sha256
-- Template Version :    8.5.1.0
-- Description      :    Update the Stage Table table stage_customer_paceaccount_national
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Wednesday, March 08, 2023 at 10:44:42
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_stage_custome_bd31bfd7].update_stage_custome_bd31bfd7
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    SET @v_sql = N'TRUNCATE TABLE [TABLEOWNER].[stage_customer_paceaccount_national]';
    ...
    BEGIN TRANSACTION
      ...
      INSERT INTO [TABLEOWNER].[stage_customer_paceaccount_national]
      ...
      SELECT  CONVERT(NVARCHAR(64),HashBytes('SHA2_256',
               ...
               COALESCE(CAST('lims80' AS VARCHAR(MAX)),'null') +'||'+
               COALESCE(CAST('lims80' AS VARCHAR(MAX)),'null')
               ),2) AS hk_l_customer_paceaccount
    ...
    SET @p_status = 1
    SET @p_return_msg = 'stage_customer_paceaccount_national updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_stage_custome_bd31bfd7 FAILED with error '
