...
-- Procedure Name   :    update_l_personnel_d_f15d08c4
...
-- Generated on     :    Monday, September 11, 2023 at 17:43:48
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_personnel_d_f15d08c4].update_l_personnel_d_f15d08c4
  @p_sequence         INTEGER
...
stage_personnel_department.hk_l_personnel_department AS hk_l_personnel_department
           , stage_personnel_department.hk_h_department AS hk_h_department
           , stage_personnel_department.hk_h_personnel AS hk_h_personnel
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_personnel_d_f15d08c4 FAILED with error '
