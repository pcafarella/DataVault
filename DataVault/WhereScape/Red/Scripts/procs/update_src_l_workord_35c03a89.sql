...
-- Procedure Name   :    update_src_l_workord_35c03a89
...
-- Generated on     :    Friday, March 17, 2023 at 13:16:01
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_workord_35c03a89].update_src_l_workord_35c03a89
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_workorder_test]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_workorder_test_madisonville.hk_l_workorder_test AS hk_l_workorder_test
           , stage_workorder_test_madisonville.hk_h_test AS hk_h_test
           , stage_workorder_test_madisonville.hk_h_work_order AS hk_h_work_order
           , stage_workorder_test_madisonville.dss_record_source AS dss_record_source
           , stage_workorder_test_madisonville.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_workorder_test_madisonville] stage_workorder_test_madisonville
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[l_workorder_test] l_workorder_test
        WHERE  stage_workorder_test_madisonville.hk_h_test = l_workorder_test.hk_h_test
        AND    stage_workorder_test_madisonville.hk_h_work_order = l_workorder_test.hk_h_work_order
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_workord_35c03a89 FAILED with error '
