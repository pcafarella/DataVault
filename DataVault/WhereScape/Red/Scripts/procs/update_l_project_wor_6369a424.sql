...
-- Procedure Name   :    update_l_project_wor_6369a424
...
-- Generated on     :    Thursday, October 06, 2022 at 10:10:01
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_project_wor_6369a424].update_l_project_wor_6369a424
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_project_workorder]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT CAST(NULL AS NCHAR(64)) AS hk_l_project_workorder
           , CAST(NULL AS NCHAR(64)) AS hk_h_work_order
           , CAST(NULL AS NCHAR(64)) AS hk_h_project
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_project_wor_6369a424 FAILED with error '
