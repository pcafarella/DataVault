...
-- Procedure Name   :    update_src_h_pace_ac_ae14309d
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:04
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_pace_ac_ae14309d].update_src_h_pace_ac_ae14309d
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_pace_account]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_pace_account_bakersfield.hk_h_pace_account AS hk_h_pace_account
           , stage_pace_account_bakersfield.pace_account_no AS pace_account_no
           , stage_pace_account_bakersfield.pace_account_no_bkcc AS pace_account_no_bkcc
           , stage_pace_account_bakersfield.tenant_id AS tenant_id
           , stage_pace_account_bakersfield.dss_record_source AS dss_record_source
           , stage_pace_account_bakersfield.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_pace_account_bakersfield] stage_pace_account_bakersfield
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_pace_ac_ae14309d FAILED with error '
