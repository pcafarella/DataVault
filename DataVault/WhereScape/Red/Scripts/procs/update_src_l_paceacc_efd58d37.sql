...
-- Procedure Name   :    update_src_l_paceacc_efd58d37
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:48:09
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_paceacc_efd58d37].update_src_l_paceacc_efd58d37
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_paceaccount_invoice]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_paceaccount_invoice_willamsport.hk_l_paceaccount_invoice AS hk_l_paceaccount_invoice
           , stage_paceaccount_invoice_willamsport.hk_h_invoice AS hk_h_invoice
           , stage_paceaccount_invoice_willamsport.hk_h_pace_account AS hk_h_pace_account
           , stage_paceaccount_invoice_willamsport.dss_record_source AS dss_record_source
           , stage_paceaccount_invoice_willamsport.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_paceaccount_invoice_willamsport] stage_paceaccount_invoice_willamsport
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_paceacc_efd58d37 FAILED with error '
