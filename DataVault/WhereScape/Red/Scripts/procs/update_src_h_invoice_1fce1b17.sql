...
-- Procedure Name   :    update_src_h_invoice_1fce1b17
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:45:54
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_invoice_1fce1b17].update_src_h_invoice_1fce1b17
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_invoice]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_invoice_bakersfield.hk_h_invoice AS hk_h_invoice
           , stage_invoice_bakersfield.invoice_no AS invoice_no
           , stage_invoice_bakersfield.invoice_no_bkcc AS invoice_no_bkcc
           , stage_invoice_bakersfield.tenant_id AS tenant_id
           , stage_invoice_bakersfield.dss_record_source AS dss_record_source
           , stage_invoice_bakersfield.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_invoice_bakersfield] stage_invoice_bakersfield
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_invoice_1fce1b17 FAILED with error '
