...
-- Procedure Name   :    update_stage_seedpak_649f0bf1
-- Template         :    wsl_sqlserver_proc_dv_stage
-- Template Version :    8.5.1.0
-- Description      :    Update the Stage Table table stage_seedpak_trans
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Monday, December 18, 2023 at 10:46:57
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_stage_seedpak_649f0bf1].update_stage_seedpak_649f0bf1
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    SET @v_sql = N'TRUNCATE TABLE [TABLEOWNER].[stage_seedpak_trans]';
    ...
    BEGIN TRANSACTION
      ...
      INSERT INTO [TABLEOWNER].[stage_seedpak_trans]
      ( column_name
      , from_value
      , to_value
      , application
      ...
      , dss_load_date
      , dss_create_time)
      SELECT  load_trans_national.column_name AS column_name
           , load_trans_national.from_value AS from_value
           , load_trans_national.to_value AS to_value
           , load_trans_national.application AS application
           , load_trans_national.specific AS specific
           , load_trans_national.lastdate AS lastdate
           , load_trans_national.lastuser AS lastuser
           , load_trans_national.lasttool AS lasttool
           , load_trans_national.dss_record_source AS dss_record_source
           , load_trans_national.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
      FROM [TABLEOWNER].[load_trans_national] load_trans_national
      ;
    ...
    SET @p_status = 1
    SET @p_return_msg = 'stage_seedpak_trans updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_stage_seedpak_649f0bf1 FAILED with error '
