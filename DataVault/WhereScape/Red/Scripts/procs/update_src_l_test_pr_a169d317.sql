...
-- Procedure Name   :    update_src_l_test_pr_a169d317
...
-- Generated on     :    Thursday, March 23, 2023 at 08:09:10
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_test_pr_a169d317].update_src_l_test_pr_a169d317
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_test_product]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_test_product_willamsport.hk_l_test_product AS hk_l_test_product
           , stage_test_product_willamsport.hk_h_product AS hk_h_product
           , stage_test_product_willamsport.hk_h_test AS hk_h_test
           , stage_test_product_willamsport.dss_record_source AS dss_record_source
           , stage_test_product_willamsport.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_test_product_willamsport] stage_test_product_willamsport
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_test_pr_a169d317 FAILED with error '
