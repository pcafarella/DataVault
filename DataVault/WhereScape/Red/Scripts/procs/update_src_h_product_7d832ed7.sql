...
-- Procedure Name   :    update_src_h_product_7d832ed7
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:14
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_product_7d832ed7].update_src_h_product_7d832ed7
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_product]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_product_willamsport.hk_h_product AS hk_h_product
           , stage_product_willamsport.product_code AS product_code
           , stage_product_willamsport.product_code_bkcc AS product_code_bkcc
           , stage_product_willamsport.tenant_id AS tenant_id
           , stage_product_willamsport.dss_record_source AS dss_record_source
           , stage_product_willamsport.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_product_willamsport] stage_product_willamsport
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_product_7d832ed7 FAILED with error '
