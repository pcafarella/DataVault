...
-- Procedure Name   :    update_src_l_project_7db22819
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:48:29
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_project_7db22819].update_src_l_project_7db22819
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_project_workorder]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_project_workorder_bakersfield.hk_l_project_workorder AS hk_l_project_workorder
           , stage_project_workorder_bakersfield.hk_h_project AS hk_h_project
           , stage_project_workorder_bakersfield.hk_h_work_order AS hk_h_work_order
           , stage_project_workorder_bakersfield.dss_record_source AS dss_record_source
           , stage_project_workorder_bakersfield.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_project_workorder_bakersfield] stage_project_workorder_bakersfield
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_project_7db22819 FAILED with error '
