...
-- Procedure Name   :    update_l_department__23d4fc05
...
-- Generated on     :    Thursday, June 29, 2023 at 14:38:11
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_department__23d4fc05].update_l_department__23d4fc05
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    FROM [stage].[stage_department_test_status_national] stage_department_test_status_national
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_department__23d4fc05 FAILED with error '
