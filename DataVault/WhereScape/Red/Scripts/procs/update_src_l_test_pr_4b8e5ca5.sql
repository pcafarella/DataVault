...
-- Procedure Name   :    update_src_l_test_pr_4b8e5ca5
...
-- Generated on     :    Thursday, March 23, 2023 at 08:09:05
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_test_pr_4b8e5ca5].update_src_l_test_pr_4b8e5ca5
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_test_product]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_test_product_madisonville.hk_l_test_product AS hk_l_test_product
           , stage_test_product_madisonville.hk_h_product AS hk_h_product
           , stage_test_product_madisonville.hk_h_test AS hk_h_test
           , stage_test_product_madisonville.dss_record_source AS dss_record_source
           , stage_test_product_madisonville.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_test_product_madisonville] stage_test_product_madisonville
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[l_test_product] l_test_product
        WHERE  stage_test_product_madisonville.hk_h_product = l_test_product.hk_h_product
        AND    stage_test_product_madisonville.hk_h_test = l_test_product.hk_h_test
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_test_pr_4b8e5ca5 FAILED with error '
