...
-- Procedure Name   :    update_src_h_pace_ac_ae14309e
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:06
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_pace_ac_ae14309e].update_src_h_pace_ac_ae14309e
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_pace_account]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_pace_account_willamsport.hk_h_pace_account AS hk_h_pace_account
           , stage_pace_account_willamsport.pace_account_no AS pace_account_no
           , stage_pace_account_willamsport.pace_account_no_bkcc AS pace_account_no_bkcc
           , stage_pace_account_willamsport.tenant_id AS tenant_id
           , stage_pace_account_willamsport.dss_record_source AS dss_record_source
           , stage_pace_account_willamsport.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_pace_account_willamsport] stage_pace_account_willamsport
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_pace_ac_ae14309e FAILED with error '
