...
-- Procedure Name   :    update_src_l_paceacc_efd58d3a
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:48:12
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_paceacc_efd58d3a].update_src_l_paceacc_efd58d3a
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_paceaccount_invoice]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_paceaccount_invoice_bakersfield.hk_l_paceaccount_invoice AS hk_l_paceaccount_invoice
           , stage_paceaccount_invoice_bakersfield.hk_h_invoice AS hk_h_invoice
           , stage_paceaccount_invoice_bakersfield.hk_h_pace_account AS hk_h_pace_account
           , stage_paceaccount_invoice_bakersfield.dss_record_source AS dss_record_source
           , stage_paceaccount_invoice_bakersfield.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_paceaccount_invoice_bakersfield] stage_paceaccount_invoice_bakersfield
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_paceacc_efd58d3a FAILED with error '
