...
-- Procedure Name   :    update_src_h_work_orde_9614e1
...
-- Generated on     :    Tuesday, April 18, 2023 at 11:59:13
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_work_orde_9614e1].update_src_h_work_orde_9614e1
  @p_sequence         INTEGER
...
stage_work_order_national.hk_h_work_order AS hk_h_work_order
           , stage_work_order_national.work_order_no AS work_order_no
           , stage_work_order_national.work_order_no_bkcc AS work_order_no_bkcc
           , stage_work_order_national.tenant_id AS tenant_id
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_work_orde_9614e1 FAILED with error '
