...
-- Procedure Name   :    update_src_h_product_7d832ed8
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:16
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_product_7d832ed8].update_src_h_product_7d832ed8
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_product]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_product_paceport.hk_h_product AS hk_h_product
           , stage_product_paceport.product_code AS product_code
           , stage_product_paceport.product_code_bkcc AS product_code_bkcc
           , stage_product_paceport.tenant_id AS tenant_id
           , stage_product_paceport.dss_record_source AS dss_record_source
           , stage_product_paceport.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_product_paceport] stage_product_paceport
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[h_product] h_product
        WHERE  stage_product_paceport.product_code = h_product.product_code
        AND    stage_product_paceport.product_code_bkcc = h_product.product_code_bkcc
        AND    stage_product_paceport.tenant_id = h_product.tenant_id
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_product_7d832ed8 FAILED with error '
