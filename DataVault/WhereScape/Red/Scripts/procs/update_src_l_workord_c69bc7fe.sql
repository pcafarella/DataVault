...
-- Procedure Name   :    update_src_l_workord_c69bc7fe
...
-- Generated on     :    Friday, March 17, 2023 at 13:16:06
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_workord_c69bc7fe].update_src_l_workord_c69bc7fe
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_workorder_test]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_workorder_test_bakersfield.hk_l_workorder_test AS hk_l_workorder_test
           , stage_workorder_test_bakersfield.hk_h_test AS hk_h_test
           , stage_workorder_test_bakersfield.hk_h_work_order AS hk_h_work_order
           , stage_workorder_test_bakersfield.dss_record_source AS dss_record_source
           , stage_workorder_test_bakersfield.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_workorder_test_bakersfield] stage_workorder_test_bakersfield
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_workord_c69bc7fe FAILED with error '
