...
-- Procedure Name   :    update_src_h_product_7d832ed9
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:17
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_product_7d832ed9].update_src_h_product_7d832ed9
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_product]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_product_eastlongmeadow.hk_h_product AS hk_h_product
           , stage_product_eastlongmeadow.product_code AS product_code
           , stage_product_eastlongmeadow.product_code_bkcc AS product_code_bkcc
           , stage_product_eastlongmeadow.tenant_id AS tenant_id
           , stage_product_eastlongmeadow.dss_record_source AS dss_record_source
           , stage_product_eastlongmeadow.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_product_eastlongmeadow] stage_product_eastlongmeadow
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_product_7d832ed9 FAILED with error '
