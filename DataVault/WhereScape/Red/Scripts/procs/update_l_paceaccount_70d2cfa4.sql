...
-- Procedure Name   :    update_l_paceaccount_70d2cfa4
...
-- Generated on     :    Thursday, October 06, 2022 at 10:09:55
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_paceaccount_70d2cfa4].update_l_paceaccount_70d2cfa4
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_paceaccount_customer_invoice]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT CAST(NULL AS NCHAR(64)) AS hk_l_paceaccount_customer_invoice
           , CAST(NULL AS NCHAR(64)) AS hk_h_pace_account
           , CAST(NULL AS NCHAR(64)) AS hk_h_invoice
           , CAST(NULL AS NCHAR(64)) AS hk_h_customer
           , CAST(NULL AS NVARCHAR(255)) AS dss_record_source
           , CAST(NULL AS DATETIME2) AS dss_load_date
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_paceaccount_70d2cfa4 FAILED with error '
