...
-- Procedure Name   :    update_l_customer_pa_d89813cc
...
-- Generated on     :    Tuesday, March 28, 2023 at 14:33:42
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_customer_pa_d89813cc].update_l_customer_pa_d89813cc
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_customer_paceaccount]
      ...
      , dss_create_time)
    SELECT --DISTINCT
CAST(NULL AS NCHAR(64)) AS hk_l_customer_paceaccount
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_customer_pa_d89813cc FAILED with error '
