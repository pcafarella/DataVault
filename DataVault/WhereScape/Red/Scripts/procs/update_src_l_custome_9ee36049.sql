...
-- Procedure Name   :    update_src_l_custome_9ee36049
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:47:27
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_custome_9ee36049].update_src_l_custome_9ee36049
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_customer_paceaccount]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_customer_paceaccount_peoria.hk_l_customer_paceaccount AS hk_l_customer_paceaccount
           , stage_customer_paceaccount_peoria.hk_h_pace_account AS hk_h_pace_account
           , stage_customer_paceaccount_peoria.hk_h_customer AS hk_h_customer
           , stage_customer_paceaccount_peoria.dss_record_source AS dss_record_source
           , stage_customer_paceaccount_peoria.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_customer_paceaccount_peoria] stage_customer_paceaccount_peoria
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_custome_9ee36049 FAILED with error '
