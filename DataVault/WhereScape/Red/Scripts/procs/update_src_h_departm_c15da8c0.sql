...
-- Procedure Name   :    update_src_h_departm_c15da8c0
...
-- Generated on     :    Wednesday, September 13, 2023 at 16:48:25
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_departm_c15da8c0].update_src_h_departm_c15da8c0
  @p_sequence         INTEGER
...
stage_department_masterdata.hk_h_department AS hk_h_department
           , stage_department_masterdata.department_no AS department_no
           , stage_department_masterdata.department_no_bkcc AS department_no_bkcc
           , stage_department_masterdata.tenant_id AS tenant_id
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_departm_c15da8c0 FAILED with error '
