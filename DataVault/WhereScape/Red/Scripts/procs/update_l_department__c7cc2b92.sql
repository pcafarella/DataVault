...
-- Procedure Name   :    update_l_department__c7cc2b92
-- Template         :    wsl_sqlserver_proc_dv_perm_sha256
-- Template Version :    8.5.1.0
-- Description      :    Update the Link table l_department_sameas
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Wednesday, September 13, 2023 at 16:48:35
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_department__c7cc2b92].update_l_department__c7cc2b92
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_department_sameas]
      ...
      , dss_create_time)
    SELECT --DISTINCT
stage_department_sameas.hk_l_department_sameas AS hk_l_department_sameas
           , stage_department_sameas.hk_h_department_department_no AS hk_h_department_department_no
           , stage_department_sameas.hk_h_department_sameas_department_no AS hk_h_department_sameas_department_no
           , stage_department_sameas.dss_record_source AS dss_record_source
           , stage_department_sameas.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_department_sameas] stage_department_sameas
        ;
    ...
    SET @p_status = 1
    SET @p_return_msg = 'l_department_sameas updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_department__c7cc2b92 FAILED with error '
