...
-- Procedure Name   :    update_src_h_sample__ce34f075
...
-- Generated on     :    Tuesday, April 18, 2023 at 11:57:05
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_sample__ce34f075].update_src_h_sample__ce34f075
  @p_sequence         INTEGER
...
stage_sample_national.hk_h_sample AS hk_h_sample
           , stage_sample_national.sample_no AS sample_no
           , stage_sample_national.sample_no_bkcc AS sample_no_bkcc
           , stage_sample_national.tenant_id AS tenant_id
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_sample__ce34f075 FAILED with error '
