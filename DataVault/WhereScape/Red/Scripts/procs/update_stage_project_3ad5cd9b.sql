...
-- Procedure Name   :    update_stage_project_3ad5cd9b
-- Template         :    wsl_sqlserver_proc_dv_stage_sha256
-- Template Version :    8.5.1.0
-- Description      :    Update the Stage Table table stage_project_workorder_national
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Wednesday, March 08, 2023 at 10:45:06
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_stage_project_3ad5cd9b].update_stage_project_3ad5cd9b
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    SET @v_sql = N'TRUNCATE TABLE [TABLEOWNER].[stage_project_workorder_national]';
    ...
    BEGIN TRANSACTION
      ...
      INSERT INTO [TABLEOWNER].[stage_project_workorder_national]
...
INNER JOIN [TABLEOWNER].[load_vw_sdg_details_national] load_vw_sdg_details_national
ON load_vw_sdg_details_national.projectnum = load_projectdef_national.projectnum
      ;
    ...
    SET @p_status = 1
    SET @p_return_msg = 'stage_project_workorder_national updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_stage_project_3ad5cd9b FAILED with error '
