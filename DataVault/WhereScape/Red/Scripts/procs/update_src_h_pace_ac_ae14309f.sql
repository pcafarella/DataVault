...
-- Procedure Name   :    update_src_h_pace_ac_ae14309f
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:07
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_pace_ac_ae14309f].update_src_h_pace_ac_ae14309f
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_pace_account]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_pace_account_eastlongmeadow.hk_h_pace_account AS hk_h_pace_account
           , stage_pace_account_eastlongmeadow.pace_account_no AS pace_account_no
           , stage_pace_account_eastlongmeadow.pace_account_no_bkcc AS pace_account_no_bkcc
           , stage_pace_account_eastlongmeadow.tenant_id AS tenant_id
           , stage_pace_account_eastlongmeadow.dss_record_source AS dss_record_source
           , stage_pace_account_eastlongmeadow.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_pace_account_eastlongmeadow] stage_pace_account_eastlongmeadow
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_pace_ac_ae14309f FAILED with error '
