...
-- Procedure Name   :    update_stage_test_pr_d5f34c8e
-- Template         :    wsl_sqlserver_proc_dv_stage_sha256
-- Template Version :    8.5.1.0
-- Description      :    Update the Stage Table table stage_test_product_national
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Thursday, April 27, 2023 at 13:56:21
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_stage_test_pr_d5f34c8e].update_stage_test_pr_d5f34c8e
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    SET @v_sql = N'TRUNCATE TABLE [TABLEOWNER].[stage_test_product_national]';
    ...
    BEGIN TRANSACTION
      ...
      INSERT INTO [TABLEOWNER].[stage_test_product_national]
      ( hk_l_test_product
      , hk_h_product
      , hk_h_test
      , test_no
...
CASE WHEN pmatnumref IS NOT NULL THEN '|'+isnull(pmatnumref,'-1') ELSE '' END AS product_code_bkcc
    ...
    SET @p_status = 1
    SET @p_return_msg = 'stage_test_product_national updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_stage_test_pr_d5f34c8e FAILED with error '
