...
-- Procedure Name   :    update_src_h_project_5857259c
...
-- Generated on     :    Thursday, March 09, 2023 at 09:08:26
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_project_5857259c].update_src_h_project_5857259c
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_project]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_project_redding.hk_h_project AS hk_h_project
           , stage_project_redding.project_no AS project_no
           , stage_project_redding.project_no_bkcc AS project_no_bkcc
           , stage_project_redding.tenant_id AS tenant_id
           , stage_project_redding.dss_record_source AS dss_record_source
           , stage_project_redding.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_project_redding] stage_project_redding
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_project_5857259c FAILED with error '
