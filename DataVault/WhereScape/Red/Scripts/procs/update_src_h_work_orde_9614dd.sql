...
-- Procedure Name   :    update_src_h_work_orde_9614dd
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:57
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_work_orde_9614dd].update_src_h_work_orde_9614dd
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_work_order]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_work_order_bakersfield.hk_h_work_order AS hk_h_work_order
           , stage_work_order_bakersfield.work_order_no AS work_order_no
           , stage_work_order_bakersfield.work_order_no_bkcc AS work_order_no_bkcc
           , stage_work_order_bakersfield.tenant_id AS tenant_id
           , stage_work_order_bakersfield.dss_record_source AS dss_record_source
           , stage_work_order_bakersfield.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_work_order_bakersfield] stage_work_order_bakersfield
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_work_orde_9614dd FAILED with error '
