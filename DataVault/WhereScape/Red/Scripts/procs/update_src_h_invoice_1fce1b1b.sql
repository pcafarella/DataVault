...
-- Procedure Name   :    update_src_h_invoice_1fce1b1b
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:45:59
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_invoice_1fce1b1b].update_src_h_invoice_1fce1b1b
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_invoice]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_invoice_peoria.hk_h_invoice AS hk_h_invoice
           , stage_invoice_peoria.invoice_no AS invoice_no
           , stage_invoice_peoria.invoice_no_bkcc AS invoice_no_bkcc
           , stage_invoice_peoria.tenant_id AS tenant_id
           , stage_invoice_peoria.dss_record_source AS dss_record_source
           , stage_invoice_peoria.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_invoice_peoria] stage_invoice_peoria
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_invoice_1fce1b1b FAILED with error '
