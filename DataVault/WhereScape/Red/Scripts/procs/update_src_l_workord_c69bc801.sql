...
-- Procedure Name   :    update_src_l_workord_c69bc801
...
-- Generated on     :    Tuesday, April 18, 2023 at 12:06:59
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_workord_c69bc801].update_src_l_workord_c69bc801
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_workorder_test]
      ...
      , dss_create_time)
    SELECT --DISTINCT
stage_workorder_test_national.hk_l_workorder_test AS hk_l_workorder_test
           , stage_workorder_test_national.hk_h_test AS hk_h_test
           , stage_workorder_test_national.hk_h_work_order AS hk_h_work_order
           , stage_workorder_test_national.dss_record_source AS dss_record_source
           , stage_workorder_test_national.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_workorder_test_national] stage_workorder_test_national
        ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_workord_c69bc801 FAILED with error '
