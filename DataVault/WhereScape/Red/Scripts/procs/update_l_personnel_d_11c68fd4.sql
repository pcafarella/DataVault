...
-- Procedure Name   :    update_l_personnel_d_11c68fd4
-- Template         :    wsl_sqlserver_proc_dv_perm_sha256
-- Template Version :    8.5.1.0
-- Description      :    Update the Link table l_personnel_department_hours
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Tuesday, October 31, 2023 at 13:09:24
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_personnel_d_11c68fd4].update_l_personnel_d_11c68fd4
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_personnel_department_hours]
...
stage_personnel_department_hours.hk_l_personnel_department_hours AS hk_l_personnel_department_hours
           , stage_personnel_department_hours.hk_h_department AS hk_h_department
           , stage_personnel_department_hours.hk_h_personnel AS hk_h_personnel
           , stage_personnel_department_hours.date_worked AS date_worked
           , stage_personnel_department_hours.payroll_name AS payroll_name
           , stage_personnel_department_hours.pay_code AS pay_code
    ...
    SET @p_status = 1
    SET @p_return_msg = 'l_personnel_department_hours updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_personnel_d_11c68fd4 FAILED with error '
