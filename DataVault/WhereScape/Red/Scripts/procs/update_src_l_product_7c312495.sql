...
-- Procedure Name   :    update_src_l_product_7c312495
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:48:17
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_product_7c312495].update_src_l_product_7c312495
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_product_parent]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_product_parent_madisonville.hk_l_product_parent AS hk_l_product_parent
           , stage_product_parent_madisonville.hk_h_product_parent_product_code AS hk_h_product_parent_product_code
           , stage_product_parent_madisonville.hk_h_product_product_code AS hk_h_product_product_code
           , stage_product_parent_madisonville.dss_record_source AS dss_record_source
           , stage_product_parent_madisonville.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_product_parent_madisonville] stage_product_parent_madisonville
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[l_product_parent] l_product_parent
        WHERE  stage_product_parent_madisonville.hk_h_product_parent_product_code = l_product_parent.hk_h_product_parent_product_code
        AND    stage_product_parent_madisonville.hk_h_product_product_code = l_product_parent.hk_h_product_product_code
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_product_7c312495 FAILED with error '
