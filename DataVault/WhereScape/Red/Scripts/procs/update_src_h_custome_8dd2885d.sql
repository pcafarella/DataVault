...
-- Procedure Name   :    update_src_h_custome_8dd2885d
-- Template         :    wsl_sqlserver_proc_dv_perm
-- Template Version :    8.5.1.0
-- Description      :    Update the Hub table h_customer
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Thursday, March 09, 2023 at 09:08:16
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_custome_8dd2885d].update_src_h_custome_8dd2885d
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_customer]
      ( hk_h_customer
      , account_no
      , account_no_bkcc
      , tenant_id
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_customer_national.hk_h_customer AS hk_h_customer
           , stage_customer_national.account_no AS account_no
           , stage_customer_national.account_no_bkcc AS account_no_bkcc
           , stage_customer_national.tenant_id AS tenant_id
    ...
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[h_customer] h_customer
        WHERE  stage_customer_national.account_no = h_customer.account_no
        AND    stage_customer_national.account_no_bkcc = h_customer.account_no_bkcc
        AND    stage_customer_national.tenant_id = h_customer.tenant_id
        )
    ;
    ...
    SET @p_status = 1
    SET @p_return_msg = 'h_customer updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_custome_8dd2885d FAILED with error '
