...
-- Procedure Name   :    update_src_h_project_5857259d
...
-- Generated on     :    Thursday, March 09, 2023 at 09:08:27
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_project_5857259d].update_src_h_project_5857259d
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_project]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_project_national.hk_h_project AS hk_h_project
           , stage_project_national.project_no AS project_no
           , stage_project_national.project_no_bkcc AS project_no_bkcc
           , stage_project_national.tenant_id AS tenant_id
    ...
    WHERE NOT EXISTS (
        ...
        WHERE  stage_project_national.project_no = h_project.project_no
        AND    stage_project_national.project_no_bkcc = h_project.project_no_bkcc
        AND    stage_project_national.tenant_id = h_project.tenant_id
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_project_5857259d FAILED with error '
