...
-- Procedure Name   :    update_src_l_project_7db2281d
...
-- Generated on     :    Tuesday, April 18, 2023 at 11:59:45
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_project_7db2281d].update_src_l_project_7db2281d
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_project_workorder]
      ...
      , dss_create_time)
    SELECT --DISTINCT
stage_project_workorder_national.hk_l_project_workorder AS hk_l_project_workorder
           , stage_project_workorder_national.hk_h_project AS hk_h_project
           , stage_project_workorder_national.hk_h_work_order AS hk_h_work_order
           , stage_project_workorder_national.dss_record_source AS dss_record_source
           , stage_project_workorder_national.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_project_workorder_national] stage_project_workorder_national
        ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_project_7db2281d FAILED with error '
