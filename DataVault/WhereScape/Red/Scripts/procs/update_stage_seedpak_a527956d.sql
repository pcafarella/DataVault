...
-- Procedure Name   :    update_stage_seedpak_a527956d
-- Template         :    wsl_sqlserver_proc_dv_stage
-- Template Version :    8.5.1.0
-- Description      :    Update the Stage Table table stage_seedpak_matrixdef
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Monday, December 18, 2023 at 10:45:24
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_stage_seedpak_a527956d].update_stage_seedpak_a527956d
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    SET @v_sql = N'TRUNCATE TABLE [TABLEOWNER].[stage_seedpak_matrixdef]';
    ...
    BEGIN TRANSACTION
      ...
      INSERT INTO [TABLEOWNER].[stage_seedpak_matrixdef]
      ( matnum
      , matrix
      , pace_matrix
      , dss_record_source
      , dss_load_date
      , dss_create_time)
      SELECT  load_matrixdef_national.matnum AS matnum
           , load_matrixdef_national.matrix AS matrix
           , load_matrixdef_national.pace_matrix AS pace_matrix
           , load_matrixdef_national.dss_record_source AS dss_record_source
           , load_matrixdef_national.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
      FROM [TABLEOWNER].[load_matrixdef_national] load_matrixdef_national
      ;
    ...
    SET @p_status = 1
    SET @p_return_msg = 'stage_seedpak_matrixdef updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_stage_seedpak_a527956d FAILED with error '
