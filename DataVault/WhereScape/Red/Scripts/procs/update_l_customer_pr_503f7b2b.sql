...
-- Procedure Name   :    update_l_customer_pr_503f7b2b
...
-- Generated on     :    Thursday, October 06, 2022 at 10:09:50
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_customer_pr_503f7b2b].update_l_customer_pr_503f7b2b
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_customer_project]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT CAST(NULL AS NCHAR(64)) AS hk_l_customer_project
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_customer_pr_503f7b2b FAILED with error '
