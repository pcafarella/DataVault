...
-- Procedure Name   :    update_src_l_custome_9ee3604b
...
-- Generated on     :    Tuesday, March 28, 2023 at 14:34:25
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_custome_9ee3604b].update_src_l_custome_9ee3604b
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_customer_paceaccount]
      ...
      , dss_create_time)
    SELECT --DISTINCT
stage_customer_paceaccount_national.hk_l_customer_paceaccount AS hk_l_customer_paceaccount
           , stage_customer_paceaccount_national.hk_h_pace_account AS hk_h_pace_account
           , stage_customer_paceaccount_national.hk_h_customer AS hk_h_customer
           , stage_customer_paceaccount_national.dss_record_source AS dss_record_source
           , stage_customer_paceaccount_national.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_customer_paceaccount_national] stage_customer_paceaccount_national
        ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_custome_9ee3604b FAILED with error '
