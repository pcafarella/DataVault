...
-- Procedure Name   :    update_src_h_departm_264b7c4d
...
-- Generated on     :    Wednesday, September 13, 2023 at 16:48:23
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_departm_264b7c4d].update_src_h_departm_264b7c4d
  @p_sequence         INTEGER
...
stage_department_national.hk_h_department AS hk_h_department
           , stage_department_national.department_no AS department_no
           , stage_department_national.department_no_bkcc AS department_no_bkcc
           , stage_department_national.tenant_id AS tenant_id
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_departm_264b7c4d FAILED with error '
