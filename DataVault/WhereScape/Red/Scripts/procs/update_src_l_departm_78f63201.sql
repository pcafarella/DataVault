...
-- Procedure Name   :    update_src_l_departm_78f63201
...
-- Generated on     :    Thursday, July 13, 2023 at 11:26:45
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_departm_78f63201].update_src_l_departm_78f63201
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_department_test_schedule]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_department_test_schedule_paceport.hk_l_department_test_schedule AS hk_l_department_test_schedule
           , stage_department_test_schedule_paceport.hk_h_test AS hk_h_test
           , stage_department_test_schedule_paceport.hk_h_department AS hk_h_department
           , stage_department_test_schedule_paceport.dss_record_source AS dss_record_source
           , stage_department_test_schedule_paceport.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_department_test_schedule_paceport] stage_department_test_schedule_paceport
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[l_department_test_schedule] l_department_test_schedule
        WHERE  stage_department_test_schedule_paceport.hk_h_test = l_department_test_schedule.hk_h_test
        AND    stage_department_test_schedule_paceport.hk_h_department = l_department_test_schedule.hk_h_department
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_departm_78f63201 FAILED with error '
