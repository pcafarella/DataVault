...
-- Procedure Name   :    update_src_h_product_7d832edd
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:22
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_product_7d832edd].update_src_h_product_7d832edd
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_product]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_product_national.hk_h_product AS hk_h_product
           , stage_product_national.product_code AS product_code
           , stage_product_national.product_code_bkcc AS product_code_bkcc
           , stage_product_national.tenant_id AS tenant_id
    ...
    WHERE NOT EXISTS (
        ...
        WHERE  stage_product_national.product_code = h_product.product_code
        AND    stage_product_national.product_code_bkcc = h_product.product_code_bkcc
        AND    stage_product_national.tenant_id = h_product.tenant_id
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_product_7d832edd FAILED with error '
