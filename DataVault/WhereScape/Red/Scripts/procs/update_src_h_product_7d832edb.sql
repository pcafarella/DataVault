...
-- Procedure Name   :    update_src_h_product_7d832edb
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:19
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_product_7d832edb].update_src_h_product_7d832edb
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_product]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_product_peoria.hk_h_product AS hk_h_product
           , stage_product_peoria.product_code AS product_code
           , stage_product_peoria.product_code_bkcc AS product_code_bkcc
           , stage_product_peoria.tenant_id AS tenant_id
           , stage_product_peoria.dss_record_source AS dss_record_source
           , stage_product_peoria.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_product_peoria] stage_product_peoria
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_product_7d832edb FAILED with error '
