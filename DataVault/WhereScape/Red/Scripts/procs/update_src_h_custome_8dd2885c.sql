...
-- Procedure Name   :    update_src_h_custome_8dd2885c
...
-- Generated on     :    Thursday, March 09, 2023 at 09:08:15
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_custome_8dd2885c].update_src_h_custome_8dd2885c
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_customer]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_customer_redding.hk_h_customer AS hk_h_customer
           , stage_customer_redding.account_no AS account_no
           , stage_customer_redding.account_no_bkcc AS account_no_bkcc
           , stage_customer_redding.tenant_id AS tenant_id
           , stage_customer_redding.dss_record_source AS dss_record_source
           , stage_customer_redding.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_customer_redding] stage_customer_redding
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_custome_8dd2885c FAILED with error '
