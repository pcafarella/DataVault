...
-- Procedure Name   :    update_src_h_sample__ce34f06f
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:34
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_sample__ce34f06f].update_src_h_sample__ce34f06f
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_sample]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_sample_willamsport.hk_h_sample AS hk_h_sample
           , stage_sample_willamsport.sample_no AS sample_no
           , stage_sample_willamsport.sample_no_bkcc AS sample_no_bkcc
           , stage_sample_willamsport.tenant_id AS tenant_id
           , stage_sample_willamsport.dss_record_source AS dss_record_source
           , stage_sample_willamsport.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_sample_willamsport] stage_sample_willamsport
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_sample__ce34f06f FAILED with error '
