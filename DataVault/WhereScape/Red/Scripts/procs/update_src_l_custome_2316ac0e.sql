...
-- Procedure Name   :    update_src_l_custome_2316ac0e
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:47:46
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_custome_2316ac0e].update_src_l_custome_2316ac0e
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_customer_workorder]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_customer_workorder_eastlongmeadow.hk_l_customer_workorder AS hk_l_customer_workorder
           , stage_customer_workorder_eastlongmeadow.hk_h_work_order AS hk_h_work_order
           , stage_customer_workorder_eastlongmeadow.hk_h_customer AS hk_h_customer
           , stage_customer_workorder_eastlongmeadow.dss_record_source AS dss_record_source
           , stage_customer_workorder_eastlongmeadow.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_customer_workorder_eastlongmeadow] stage_customer_workorder_eastlongmeadow
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_custome_2316ac0e FAILED with error '
