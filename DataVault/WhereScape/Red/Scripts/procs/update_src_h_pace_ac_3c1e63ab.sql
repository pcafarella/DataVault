...
-- Procedure Name   :    update_src_h_pace_ac_3c1e63ab
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:03
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_pace_ac_3c1e63ab].update_src_h_pace_ac_3c1e63ab
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_pace_account]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_pace_account_madisonville.hk_h_pace_account AS hk_h_pace_account
           , stage_pace_account_madisonville.pace_account_no AS pace_account_no
           , stage_pace_account_madisonville.pace_account_no_bkcc AS pace_account_no_bkcc
           , stage_pace_account_madisonville.tenant_id AS tenant_id
           , stage_pace_account_madisonville.dss_record_source AS dss_record_source
           , stage_pace_account_madisonville.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_pace_account_madisonville] stage_pace_account_madisonville
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[h_pace_account] h_pace_account
        WHERE  stage_pace_account_madisonville.pace_account_no = h_pace_account.pace_account_no
        AND    stage_pace_account_madisonville.pace_account_no_bkcc = h_pace_account.pace_account_no_bkcc
        AND    stage_pace_account_madisonville.tenant_id = h_pace_account.tenant_id
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_pace_ac_3c1e63ab FAILED with error '
