...
-- Procedure Name   :    update_src_l_personn_897ea343
...
-- Generated on     :    Wednesday, September 13, 2023 at 16:48:36
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_personn_897ea343].update_src_l_personn_897ea343
  @p_sequence         INTEGER
...
stage_personnel_department_vault.hk_l_personnel_department AS hk_l_personnel_department
           , stage_personnel_department_vault.hk_h_department AS hk_h_department
           , stage_personnel_department_vault.hk_h_personnel AS hk_h_personnel
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_personn_897ea343 FAILED with error '
