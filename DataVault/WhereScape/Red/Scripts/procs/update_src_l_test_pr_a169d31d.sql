...
-- Procedure Name   :    update_src_l_test_pr_a169d31d
...
-- Generated on     :    Tuesday, April 18, 2023 at 12:06:05
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_test_pr_a169d31d].update_src_l_test_pr_a169d31d
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_test_product]
      ...
      , dss_create_time)
    SELECT --DISTINCT
stage_test_product_national.hk_l_test_product AS hk_l_test_product
           , stage_test_product_national.hk_h_product AS hk_h_product
           , stage_test_product_national.hk_h_test AS hk_h_test
           , stage_test_product_national.dss_record_source AS dss_record_source
           , stage_test_product_national.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_test_product_national] stage_test_product_national
        ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_test_pr_a169d31d FAILED with error '
