...
-- Procedure Name   :    update_src_h_test_3_6fdfd8c1
-- Template         :    wsl_sqlserver_proc_dv_perm
-- Template Version :    8.5.1.0
-- Description      :    Update the Hub table h_test
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Tuesday, July 11, 2023 at 10:44:36
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_test_3_6fdfd8c1].update_src_h_test_3_6fdfd8c1
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_test]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_test_eastlongmeadow.hk_h_test AS hk_h_test
           , stage_test_eastlongmeadow.test_no AS test_no
           , stage_test_eastlongmeadow.test_no_bkcc AS test_no_bkcc
           , stage_test_eastlongmeadow.tenant_id AS tenant_id
           , stage_test_eastlongmeadow.dss_record_source AS dss_record_source
           , stage_test_eastlongmeadow.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_test_eastlongmeadow] stage_test_eastlongmeadow
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[h_test] h_test
        WHERE  stage_test_eastlongmeadow.test_no = h_test.test_no
        AND    stage_test_eastlongmeadow.test_no_bkcc = h_test.test_no_bkcc
        AND    stage_test_eastlongmeadow.tenant_id = h_test.tenant_id
        )
    ;
    ...
    SET @p_status = 1
    SET @p_return_msg = 'h_test updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_test_3_6fdfd8c1 FAILED with error '
