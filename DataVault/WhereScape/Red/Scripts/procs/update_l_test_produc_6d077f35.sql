...
-- Procedure Name   :    update_l_test_produc_6d077f35
...
-- Generated on     :    Thursday, October 06, 2022 at 10:10:05
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_test_produc_6d077f35].update_l_test_produc_6d077f35
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_test_product]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT CAST(NULL AS NCHAR(64)) AS hk_l_test_product
           , CAST(NULL AS NCHAR(64)) AS hk_h_product
           , CAST(NULL AS NCHAR(64)) AS hk_h_test
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_test_produc_6d077f35 FAILED with error '
