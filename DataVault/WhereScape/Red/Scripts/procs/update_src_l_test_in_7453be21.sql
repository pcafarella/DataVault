...
-- Procedure Name   :    update_src_l_test_in_7453be21
-- Template         :    wsl_sqlserver_proc_dv_perm
-- Template Version :    8.5.1.0
-- Description      :    Update the Link table l_test_invoice
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Wednesday, March 08, 2023 at 10:48:38
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_test_in_7453be21].update_src_l_test_in_7453be21
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_test_invoice]
      ( hk_l_test_invoice
      , hk_h_test
      , hk_h_invoice
      , dss_record_source
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_test_invoice_madisonville.hk_l_test_invoice AS hk_l_test_invoice
           , stage_test_invoice_madisonville.hk_h_test AS hk_h_test
           , stage_test_invoice_madisonville.hk_h_invoice AS hk_h_invoice
           , stage_test_invoice_madisonville.dss_record_source AS dss_record_source
           , stage_test_invoice_madisonville.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_test_invoice_madisonville] stage_test_invoice_madisonville
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[l_test_invoice] l_test_invoice
        WHERE  stage_test_invoice_madisonville.hk_h_test = l_test_invoice.hk_h_test
        AND    stage_test_invoice_madisonville.hk_h_invoice = l_test_invoice.hk_h_invoice
        )
    ;
    ...
    SET @p_status = 1
    SET @p_return_msg = 'l_test_invoice updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_test_in_7453be21 FAILED with error '
