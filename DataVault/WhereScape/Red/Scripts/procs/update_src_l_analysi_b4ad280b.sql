...
-- Procedure Name   :    update_src_l_analysi_b4ad280b
...
-- Generated on     :    Thursday, August 17, 2023 at 12:19:33
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_analysi_b4ad280b].update_src_l_analysi_b4ad280b
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_analysis_process_product]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_analysis_process_product_paceport.hk_l_analysis_process_product AS hk_l_analysis_process_product
           , stage_analysis_process_product_paceport.hk_h_product AS hk_h_product
           , stage_analysis_process_product_paceport.hk_h_analysis_process AS hk_h_analysis_process
           , stage_analysis_process_product_paceport.dss_record_source AS dss_record_source
           , stage_analysis_process_product_paceport.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_analysis_process_product_paceport] stage_analysis_process_product_paceport
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_analysi_b4ad280b FAILED with error '
