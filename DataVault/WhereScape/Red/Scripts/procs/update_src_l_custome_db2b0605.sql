...
-- Procedure Name   :    update_src_l_custome_db2b0605
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:47:35
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_custome_db2b0605].update_src_l_custome_db2b0605
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_customer_project]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_customer_project_eastlongmeadow.hk_l_customer_project AS hk_l_customer_project
           , stage_customer_project_eastlongmeadow.hk_h_project AS hk_h_project
           , stage_customer_project_eastlongmeadow.hk_h_customer AS hk_h_customer
           , stage_customer_project_eastlongmeadow.dss_record_source AS dss_record_source
           , stage_customer_project_eastlongmeadow.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_customer_project_eastlongmeadow] stage_customer_project_eastlongmeadow
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_custome_db2b0605 FAILED with error '
