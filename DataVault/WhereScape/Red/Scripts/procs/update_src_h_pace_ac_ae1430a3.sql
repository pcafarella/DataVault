...
-- Procedure Name   :    update_src_h_pace_ac_ae1430a3
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:12
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_pace_ac_ae1430a3].update_src_h_pace_ac_ae1430a3
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_pace_account]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_pace_account_national.hk_h_pace_account AS hk_h_pace_account
           , stage_pace_account_national.pace_account_no AS pace_account_no
           , stage_pace_account_national.pace_account_no_bkcc AS pace_account_no_bkcc
           , stage_pace_account_national.tenant_id AS tenant_id
           , stage_pace_account_national.dss_record_source AS dss_record_source
           , stage_pace_account_national.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_pace_account_national] stage_pace_account_national
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[h_pace_account] h_pace_account
        WHERE  stage_pace_account_national.pace_account_no = h_pace_account.pace_account_no
        AND    stage_pace_account_national.pace_account_no_bkcc = h_pace_account.pace_account_no_bkcc
        AND    stage_pace_account_national.tenant_id = h_pace_account.tenant_id
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_pace_ac_ae1430a3 FAILED with error '
