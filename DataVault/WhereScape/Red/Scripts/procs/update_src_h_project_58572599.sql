...
-- Procedure Name   :    update_src_h_project_58572599
...
-- Generated on     :    Thursday, March 09, 2023 at 09:08:22
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_project_58572599].update_src_h_project_58572599
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_project]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_project_bakersfield.hk_h_project AS hk_h_project
           , stage_project_bakersfield.project_no AS project_no
           , stage_project_bakersfield.project_no_bkcc AS project_no_bkcc
           , stage_project_bakersfield.tenant_id AS tenant_id
           , stage_project_bakersfield.dss_record_source AS dss_record_source
           , stage_project_bakersfield.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_project_bakersfield] stage_project_bakersfield
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_project_58572599 FAILED with error '
