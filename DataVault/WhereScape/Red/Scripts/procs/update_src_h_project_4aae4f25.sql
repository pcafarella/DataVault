...
-- Procedure Name   :    update_src_h_project_4aae4f25
...
-- Generated on     :    Thursday, March 09, 2023 at 09:08:18
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_project_4aae4f25].update_src_h_project_4aae4f25
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_project]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_project_madisonville.hk_h_project AS hk_h_project
           , stage_project_madisonville.project_no AS project_no
           , stage_project_madisonville.project_no_bkcc AS project_no_bkcc
           , stage_project_madisonville.tenant_id AS tenant_id
           , stage_project_madisonville.dss_record_source AS dss_record_source
           , stage_project_madisonville.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_project_madisonville] stage_project_madisonville
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[h_project] h_project
        WHERE  stage_project_madisonville.project_no = h_project.project_no
        AND    stage_project_madisonville.project_no_bkcc = h_project.project_no_bkcc
        AND    stage_project_madisonville.tenant_id = h_project.tenant_id
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_project_4aae4f25 FAILED with error '
