...
-- Procedure Name   :    update_src_l_test_in_ae5cc594
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:48:41
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_test_in_ae5cc594].update_src_l_test_in_ae5cc594
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_test_invoice]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_test_invoice_eastlongmeadow.hk_l_test_invoice AS hk_l_test_invoice
           , stage_test_invoice_eastlongmeadow.hk_h_test AS hk_h_test
           , stage_test_invoice_eastlongmeadow.hk_h_invoice AS hk_h_invoice
           , stage_test_invoice_eastlongmeadow.dss_record_source AS dss_record_source
           , stage_test_invoice_eastlongmeadow.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_test_invoice_eastlongmeadow] stage_test_invoice_eastlongmeadow
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_test_in_ae5cc594 FAILED with error '
