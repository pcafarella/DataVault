...
-- Procedure Name   :    update_src_h_departm_c15da8bf
...
-- Generated on     :    Wednesday, September 13, 2023 at 16:48:24
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_departm_c15da8bf].update_src_h_departm_c15da8bf
  @p_sequence         INTEGER
...
stage_department_paceport.hk_h_department AS hk_h_department
           , stage_department_paceport.department_no AS department_no
           , stage_department_paceport.department_no_bkcc AS department_no_bkcc
           , stage_department_paceport.tenant_id AS tenant_id
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_departm_c15da8bf FAILED with error '
