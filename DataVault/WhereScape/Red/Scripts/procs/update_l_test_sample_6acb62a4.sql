...
-- Procedure Name   :    update_l_test_sample_6acb62a4
...
-- Generated on     :    Thursday, October 06, 2022 at 10:10:07
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_test_sample_6acb62a4].update_l_test_sample_6acb62a4
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_test_sample]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT CAST(NULL AS NCHAR(64)) AS hk_l_test_sample
           , CAST(NULL AS NCHAR(64)) AS hk_h_sample
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_test_sample_6acb62a4 FAILED with error '
