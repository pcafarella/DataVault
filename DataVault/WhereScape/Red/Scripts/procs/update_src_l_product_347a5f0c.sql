...
-- Procedure Name   :    update_src_l_product_347a5f0c
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:48:24
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_product_347a5f0c].update_src_l_product_347a5f0c
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_product_347a5f0c FAILED with error '
