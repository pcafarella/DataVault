...
-- Procedure Name   :    update_stage_product_b2e68016
-- Template         :    wsl_sqlserver_proc_dv_stage_sha256
-- Template Version :    8.5.1.0
-- Description      :    Update the Stage Table table stage_product_parent_national
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Wednesday, March 08, 2023 at 10:45:03
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_stage_product_b2e68016].update_stage_product_b2e68016
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    SET @v_sql = N'TRUNCATE TABLE [TABLEOWNER].[stage_product_parent_national]';
    ...
    BEGIN TRANSACTION
      ...
      INSERT INTO [TABLEOWNER].[stage_product_parent_national]
      ( hk_l_product_parent
...
CASE WHEN pmatnumref IS NOT NULL THEN '|'+isnull(pmatnumref,'-1') ELSE '' END AS VARCHAR(MAX)),'null') +'||'+
               COALESCE(CAST('lims80' AS VARCHAR(MAX)),'null')
               ),2) AS hk_h_product_product_code
           , Coalesce(prod,'-1') +
...
CASE WHEN pmatnumref IS NOT NULL THEN '|'+isnull(pmatnumref,'-1') ELSE '' END AS product_code_bkcc
           ...
           , ISNULL(pprodref,'-1') AS parent_product_code
           , ISNULL(pmatnumref,'-1') AS parent_product_code_bkcc
           , 'lims80' AS parent_product_code_tenant_id
    ...
    SET @p_status = 1
    SET @p_return_msg = 'stage_product_parent_national updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_stage_product_b2e68016 FAILED with error '
