...
-- Procedure Name   :    update_r_seedpak_tra_2d11ae65
-- Template         :    wsl_sqlserver_proc_stage
-- Template Version :    8.1.1.0
-- Description      :    Update the EDW 3NF table r_seedpak_trans
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Wednesday, August 16, 2023 at 11:11:33
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_r_seedpak_tra_2d11ae65].update_r_seedpak_tra_2d11ae65
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    BEGIN TRANSACTION
      ...
      INSERT INTO [TABLEOWNER].[r_seedpak_trans]
      ( column_name
      , from_value
      , to_value
      , application
      ...
      SELECT  stage_seedpak_trans.column_name AS column_name
           , stage_seedpak_trans.from_value AS from_value
           , stage_seedpak_trans.to_value AS to_value
           , stage_seedpak_trans.application AS application
           , stage_seedpak_trans.specific AS specific
           , stage_seedpak_trans.lastdate AS lastdate
           , stage_seedpak_trans.lastuser AS lastuser
           , stage_seedpak_trans.lasttool AS lasttool
           , stage_seedpak_trans.dss_record_source AS dss_record_source
           , stage_seedpak_trans.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
      FROM [TABLEOWNER].[stage_seedpak_trans] stage_seedpak_trans
      ;
    ...
    SET @p_status = 1
    SET @p_return_msg = 'r_seedpak_trans updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_r_seedpak_tra_2d11ae65 FAILED with error '
