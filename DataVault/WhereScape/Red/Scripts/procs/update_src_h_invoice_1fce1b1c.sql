...
-- Procedure Name   :    update_src_h_invoice_1fce1b1c
...
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:01
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_invoice_1fce1b1c].update_src_h_invoice_1fce1b1c
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_invoice]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_invoice_redding.hk_h_invoice AS hk_h_invoice
           , stage_invoice_redding.invoice_no AS invoice_no
           , stage_invoice_redding.invoice_no_bkcc AS invoice_no_bkcc
           , stage_invoice_redding.tenant_id AS tenant_id
           , stage_invoice_redding.dss_record_source AS dss_record_source
           , stage_invoice_redding.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_invoice_redding] stage_invoice_redding
    WHERE NOT EXISTS (
        SELECT 1
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_invoice_1fce1b1c FAILED with error '
