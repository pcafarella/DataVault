...
-- Procedure Name   :    update_src_h_test_7_6fdfd8c5
...
-- Generated on     :    Tuesday, July 11, 2023 at 10:44:40
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_test_7_6fdfd8c5].update_src_h_test_7_6fdfd8c5
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    SELECT DISTINCT stage_test_national.hk_h_test AS hk_h_test
           , stage_test_national.test_no AS test_no
           , stage_test_national.test_no_bkcc AS test_no_bkcc
           , stage_test_national.tenant_id AS tenant_id
    ...
    WHERE NOT EXISTS (
        ...
        WHERE  stage_test_national.test_no = h_test.test_no
        AND    stage_test_national.test_no_bkcc = h_test.test_no_bkcc
        AND    stage_test_national.tenant_id = h_test.tenant_id
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_test_7_6fdfd8c5 FAILED with error '
