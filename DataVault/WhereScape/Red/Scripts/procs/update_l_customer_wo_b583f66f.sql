...
-- Procedure Name   :    update_l_customer_wo_b583f66f
...
-- Generated on     :    Thursday, October 06, 2022 at 10:09:52
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_customer_wo_b583f66f].update_l_customer_wo_b583f66f
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_customer_workorder]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT CAST(NULL AS NCHAR(64)) AS hk_l_customer_workorder
           , CAST(NULL AS NCHAR(64)) AS hk_h_work_order
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_customer_wo_b583f66f FAILED with error '
