...
-- Procedure Name   :    update_src_l_departm_d4cb9e45
...
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_departm_d4cb9e45].update_src_l_departm_d4cb9e45
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    SELECT DISTINCT stage_department_test_status_national.hk_l_department_test_status AS hk_l_department_test_status
           , stage_department_test_status_national.hk_h_test AS hk_h_test
           , stage_department_test_status_national.hk_h_department AS hk_h_department
           , stage_department_test_status_national.process_status_code AS process_status_code
           , stage_department_test_status_national.process_status_date AS process_status_date
    ...
    WHERE NOT EXISTS (
        ...
        WHERE  stage_department_test_status_national.hk_h_test = l_department_test_status.hk_h_test
        AND    stage_department_test_status_national.hk_h_department = l_department_test_status.hk_h_department
        AND    stage_department_test_status_national.process_status_code = l_department_test_status.process_status_code
        AND    stage_department_test_status_national.process_status_date = l_department_test_status.process_status_date
        )
    ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_departm_d4cb9e45 FAILED with error '
