...
-- Procedure Name   :    update_src_l_personn_2462ea35
-- Template         :    wsl_sqlserver_proc_dv_perm_sha256
-- Template Version :    8.5.1.0
-- Description      :    Update the Link table l_personnel_department
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Wednesday, September 13, 2023 at 16:48:37
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_personn_2462ea35].update_src_l_personn_2462ea35
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_personnel_department]
      ...
      , dss_create_time)
    SELECT --DISTINCT
stage_personnel_department_masterdata.hk_l_personnel_department AS hk_l_personnel_department
           , stage_personnel_department_masterdata.hk_h_department AS hk_h_department
           , stage_personnel_department_masterdata.hk_h_personnel AS hk_h_personnel
           , stage_personnel_department_masterdata.dss_record_source AS dss_record_source
           , stage_personnel_department_masterdata.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_personnel_department_masterdata] stage_personnel_department_masterdata
        ;
    ...
    SET @p_status = 1
    SET @p_return_msg = 'l_personnel_department updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_personn_2462ea35 FAILED with error '
