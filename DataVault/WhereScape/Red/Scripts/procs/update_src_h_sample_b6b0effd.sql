...
-- Procedure Name   :    update_src_h_sample_b6b0effd
-- Template         :    wsl_sqlserver_proc_dv_perm
-- Template Version :    8.5.1.0
-- Description      :    Update the Hub table h_sample
-- Generated by     :    WhereScape RED Version 8.6.6.1 (build 220216-231917)
-- Generated for    :    Pace Analytical Services
-- Generated on     :    Wednesday, March 08, 2023 at 10:46:33
-- Author           :
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_h_sample_b6b0effd].update_src_h_sample_b6b0effd
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[h_sample]
      ( hk_h_sample
      , sample_no
      , sample_no_bkcc
      , tenant_id
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT stage_sample_madisonville.hk_h_sample AS hk_h_sample
           , stage_sample_madisonville.sample_no AS sample_no
           , stage_sample_madisonville.sample_no_bkcc AS sample_no_bkcc
           , stage_sample_madisonville.tenant_id AS tenant_id
           , stage_sample_madisonville.dss_record_source AS dss_record_source
           , stage_sample_madisonville.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_sample_madisonville] stage_sample_madisonville
    WHERE NOT EXISTS (
        SELECT 1
        FROM   [TABLEOWNER].[h_sample] h_sample
        WHERE  stage_sample_madisonville.sample_no = h_sample.sample_no
        AND    stage_sample_madisonville.sample_no_bkcc = h_sample.sample_no_bkcc
        AND    stage_sample_madisonville.tenant_id = h_sample.tenant_id
        )
    ;
    ...
    SET @p_status = 1
    SET @p_return_msg = 'h_sample updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_h_sample_b6b0effd FAILED with error '
