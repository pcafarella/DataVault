...
-- Procedure Name   :    update_l_workorder_t_c0a6c4e7
...
-- Generated on     :    Thursday, October 06, 2022 at 10:10:10
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_l_workorder_t_c0a6c4e7].update_l_workorder_t_c0a6c4e7
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_workorder_test]
      ...
      , dss_load_date
      , dss_create_time)
    SELECT DISTINCT CAST(NULL AS NCHAR(64)) AS hk_l_workorder_test
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_l_workorder_t_c0a6c4e7 FAILED with error '
