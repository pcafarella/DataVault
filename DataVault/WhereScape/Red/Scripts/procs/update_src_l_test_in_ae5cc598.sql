...
-- Procedure Name   :    update_src_l_test_in_ae5cc598
...
-- Generated on     :    Tuesday, April 18, 2023 at 12:05:39
-- Author           :    Paul Cafarella
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.update_src_l_test_in_ae5cc598].update_src_l_test_in_ae5cc598
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    INSERT INTO [TABLEOWNER].[l_test_invoice]
      ...
      , dss_create_time)
    SELECT --DISTINCT
stage_test_invoice_national.hk_l_test_invoice AS hk_l_test_invoice
           , stage_test_invoice_national.hk_h_test AS hk_h_test
           , stage_test_invoice_national.hk_h_invoice AS hk_h_invoice
           , stage_test_invoice_national.dss_record_source AS dss_record_source
           , stage_test_invoice_national.dss_load_date AS dss_load_date
           , @v_current_datetime AS dss_create_time
    FROM [TABLEOWNER].[stage_test_invoice_national] stage_test_invoice_national
        ;
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('update_src_l_test_in_ae5cc598 FAILED with error '
