/****** Object:  StoredProcedure [info].[usp_fact_invoiceline_national_erfree]    Script Date: 1/30/2024 2:45:18 PM ******/
DROP PROCEDURE [info].[usp_fact_invoiceline_national_erfree]
GO
/****** Object:  StoredProcedure [info].[usp_fact_invoiceline_national_erfree]    Script Date: 1/30/2024 2:45:18 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE     PROCEDURE [info].[usp_fact_invoiceline_national_erfree] AS 

-- exec info.usp_fact_invoiceline_national_erfree

IF Object_id('info.fact_invoiceline_national_erfree') IS NOT NULL drop table info.fact_invoiceline_national_erfree
...
AND sinc.invoicedate >= '2021-01-01'   --4,807,504   00:07:05
 AND b.pace_account_no NOT IN ('80-110488','80-112262','80-110784','80-113146','80-113691','75-100996','77-101091','80-107947','80-108381')
