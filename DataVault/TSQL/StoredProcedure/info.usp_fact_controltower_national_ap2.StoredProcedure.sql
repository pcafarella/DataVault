/****** Object:  StoredProcedure [info].[usp_fact_controltower_national_ap2]    Script Date: 2/12/2024 2:38:03 PM ******/
...
-- exec info.usp_fact_controltower_national_ap2 'L1704609' --'L1688539'--'L1699159'--'L1698718'--'L1699291' --'L1663905'-- 'L1695196'  -- 'L1695618'  'L1672958'    'L1693822' 
-- select top 1000 * from info.fact_controltower_national_ap2   WHERE sample_no LIKE '%01%' and  (analysis_process_code like 'V8260BTEX') order by   sample_no, analysis_process_code, analysis_process_code_bkcc
...
SELECT f.sample_no, f.analysis_process_code, f.analysis_process_code_bkcc, product_code_base, d.department_no, department_short_name, ISNULL(process_status_batch_no,'') process_status_batch_no, MAX(process_status_date) process_status_date,
	MAX(ISNULL(dept_avail_date,'1900-01-01')) dept_avail_date, MAX(ISNULL(dept_batch_date,'1900-01-01')) dept_batch_date, MAX(ISNULL(work_inprogress_date,'1900-01-01')) work_inprogress_date,
	MAX(ISNULL(work_capture_date,'1900-01-01')) work_capture_date, MAX(ISNULL(work_complete_date,'1900-01-01')) work_complete_date, MAX(a.batch_no_cnt) batch_no_cnt
INTO #preprep1
FROM info.fact_controltower_national f
INNER JOIN #sample_analysis_process a ON a.sample_no = f.sample_no AND a.analysis_process_code = f.analysis_process_code AND a.analysis_process_code_bkcc = f.analysis_process_code_bkcc
...
;WITH allbatch AS (
SELECT 1.00 department_level, sample_no, analysis_process_code, analysis_process_code_bkcc, department_no, process_status_batch_no from #login
UNION
SELECT 1.00 department_level, sample_no, analysis_process_code, analysis_process_code_bkcc, department_no, process_status_batch_no from #preprep
UNION
SELECT 2.00 department_level, sample_no, analysis_process_code, analysis_process_code_bkcc, department_no, process_status_batch_no FROM #prep
UNION
SELECT 3.00 department_level, sample_no, analysis_process_code, analysis_process_code_bkcc, department_no, process_status_batch_no FROM #analytical)
...
SELECT sa.work_order_no
      ...
      ,lp.batch_no_cnt [preprep_dept_batch_no_cnt]
      ...
      ,p.batch_no_cnt [prep_dept_batch_no_cnt]
      ...
      ,a.batch_no_cnt [analysis_dept_batch_no_cnt]
