/****** Object:  StoredProcedure [info].[usp_fact_invoiceline_national_er]    Script Date: 1/30/2024 2:45:18 PM ******/
DROP PROCEDURE [info].[usp_fact_invoiceline_national_er]
GO
/****** Object:  StoredProcedure [info].[usp_fact_invoiceline_national_er]    Script Date: 1/30/2024 2:45:18 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE    PROCEDURE [info].[usp_fact_invoiceline_national_er] AS 

-- exec info.usp_fact_invoiceline_national_er

IF Object_id('info.fact_invoiceline_national_er') IS NOT NULL drop table info.fact_invoiceline_national_er
...
AND sinc.invoicedate >= '2021-01-01'   --4,807,504   00:07:05
 AND b.pace_account_no  IN ('80-110488','80-112262','80-110784','80-113146','80-113691','92-617836','92-620669','75-100996','77-101091','80-107947','80-108381')
